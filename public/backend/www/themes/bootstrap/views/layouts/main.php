	...
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/app/css/normalize.css">
        ...
        <!-- FONTS -->
   		...
   		<!-- PLUGIN CSS -->
            ...
            <!-- <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/bootstrap/bootstrap-responsive.css" rel="stylesheet" type="text/css" />-->
            ...
            <link href="<?php echo Yii::app()->request->baseUrl; ?>/tplugins/search/tipuesearch.css" type="text/css" rel="stylesheet" />
            <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/nivo-slider.css">
            <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/nivo-themes/bar/bar.css" type="text/css" media="screen" />
            <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/nivo-themes/light/light.css" type="text/css" media="screen" />
            ...
            <!-- BACKEND STYLES -->
            <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/backend.css" rel="stylesheet" type="text/css"  media="screen" /> 
